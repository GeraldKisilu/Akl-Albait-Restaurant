...
import { menuItems as menuDataItems } from "./menuData";

// Build a lookup from menuData.ts for images by item ID
const imageMap = Object.fromEntries(menuDataItems.map(m => [m.id, m.img]));
...
// ─── Menu Data ────────────────────────────────────────────────────────────────
// Categories derived dynamically from menuData.ts, excluding "Meals & Deals"
...
const ITEMS: MenuItem[] = [
  ...
  { id: "r2", category: "Rice & Biryani", name: "Vegetable Fried Rice", price: 10,
    ...
    image: imageMap["r2"] ?? "" },
  { id: "r3", category: "Rice & Biryani", name: "Vegetable Pilau", price: 8,
    description: "Aromatic basmati rice slow-cooked with whole spices and vegetables.",
    image: imageMap["r3"] ?? "" },
  { id: "r4", category: "Rice & Biryani", name: "Jeera Pilau", price: 8,
  ...
  { id: "c2", category: "Indian & Pakistani Curries", name: "Butter Chicken", price: 16, featured: true,
    ...
    image: imageMap["c2"] ?? "",
    customizations: [{ label: "Spice Level", choices: [{ name: "Mild" }, { name: "Medium" }, { name: "Hot" }] }] },
  { id: "c3", category: "Indian & Pakistani Curries", name: "Chicken Curry", price: 16,
  ...
  { id: "dr1", category: "Soft Drinks", name: "Coca-Cola Can (320ml)", price: 4,
    description: "Ice-cold Coca-Cola, 320ml can.", image: imageMap["dr1"] ?? "" },
  { id: "dr2", category: "Soft Drinks", name: "Pepsi Can (330ml)", price: 4,
    description: "Chilled Pepsi, 330ml can.", image: imageMap["dr2"] ?? "" },
  { id: "dr3", category: "Soft Drinks", name: "Water Bottle (500ml)", price: 1,
    description: "Still mineral water, 500ml.", image: imageMap["dr3"] ?? "" },
  { id: "dr4", category: "Soft Drinks", name: "Coca-Cola 1.5L", price: 2,
    description: "Large bottle of Coca-Cola, 1.5 litres. Perfect for sharing.", image: imageMap["dr4"] ?? "" },
  { id: "dr5", category: "Soft Drinks", name: "Pepsi 1.5L", price: 5,
    description: "Large bottle of Pepsi, 1.5 litres.", image: imageMap["dr5"] ?? "" },
